			...
			<div class="section-a-body">
				<div class="section-f section-f-fixed-800 m-t-10">
					...
					<form id="saveForm" method="POST" action="">
						...
						<div class="section-f-body">
							...
							<div class="san-row section-f-row">
								...
								<div class="san-col-3">
									<input id="examinationName" name="examinationName" value="${examinationDetail.examinationName}" class="easyui-textbox" style="width: 100%;" data-options="required:true,validType:'length[0,100]'">
								</div>
							...
							<div class="san-row section-f-row">
								...
								<div class="san-col-3">				
									<input id="totalScore" name="totalScore" value="${examinationDetail.totalScore}" disabled="disabled" class="easyui-textbox" style="width: 100%;">
								</div>
							...
							<div class="san-row section-f-row">
								...
								<div class="san-col-3" style="width:75%">
									<input id="examinationRemark" name="examinationRemark" value="${examinationDetail.examinationRemark}" class="easyui-textbox"
					...
					<div class="section-f-foot AR">
							<a id="cancelUpdate" href="#"
							class="easyui-linkbutton mw-70 m-r-10 z-easyui-bg-primary">取消</a>
							<a id="lastPage" href="#"
							class="easyui-linkbutton mw-70 m-r-10 z-easyui-bg-primary">试题管理</a>
							<a id="updateExamination" href="#"
		...
		$(function() {
			...
			$("#saveForm").form({
				...
				success : function(data) {
					...
					if (result.saveFlag) {
						//成功框确认按钮点击事件
						showSuccessMsgDia(result.msg,'examination/examinationManage');
					}else {
			...
			$("#examinationId").val("${examinationDetail.examinationId}");
			...
			$("#examinatioInfoTable").datagrid({
 			...
 			$("#examinationStatus").combobox({
				...
				onLoadSuccess:function(){
					$("#examinationStatus").combobox("setValue", "${examinationDetail.examinationStatus}");
				}
			}); 

 			if("${action}"==null||"${action}"==''){
 				debugger;
				$("#examinatioInfoTable").datagrid({url : "examination/questionList?examinationId=${examinationDetail.examinationId}"});
				$('#examinatioInfoTable').datagrid('reload');
 			}
 			
			//新增页面保存按钮
			$("#updateExamination").bind("click", function() {
				//debugger;
				endEditing();//该方法用于关闭上一个焦点的editing状态 
				//debugger;
			...
			$("#lastPage").bind("click",function(){
				...
				$('#main-page-body-content').sanJumpto({
					url:'examination/addExamination?examinationId=${examinationDetail.examinationId}',
				    onBefore:function(){
			...
			$("#cancelUpdate").bind("click",function(){
				$('#main-page-body-content').sanJumpto({
					url:'examination/examinationManage'				    
				});
			});
