	...
	$.fn.validatebox.defaults = {
		...
		rules : {
			stuNo : {
				...
				message : "Please enter a valid stuNo address."
			},
			url : {
		...
		buttons : [
				{
					...
					text : function(_b45) {
						return $(_b45).datebox("options").cleanText;
					},
					handler : function(_b46) {
						$(_b46).combo("setValue", "").combo("setText", ""); // 设置空值
						$(_b46).combo("hidePanel"); // 点击清空按钮之后关闭日期选择面板
					}
				}, {
					text : function(_b47) {
